...
console.log("===== BAGIAN 9 =====");
 
console.log("\n-- Latihan 9.1: groupByCategory --");
const grouped = groupByCategory(products);
console.log("Kategori 'accessories':", grouped["accessories"].map(p => p.title));
 
console.log("\n-- Latihan 9.2: Ringkasan jumlah produk per kategori --");
console.table(summarizeCategories(grouped));